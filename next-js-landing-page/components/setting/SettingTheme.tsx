...
function SettingTheme(props) {
  ...
  return (
    ...
    <div title="Change Theme" className={`dropdown ${props?.dropdownLocation}`}>
    ...
    <div className="dropdown-content bg-base-200 text-base-content rounded-t-box rounded-b-box top-px max-h-96  w-52 overflow-y-auto shadow-2xl mt-16">
      ...
      {themeList.map((themeNow) => 
        

            <div key={themeNow} className="grid grid-cols-1 gap-3 p-3" tabIndex={0}>
              <div
                className="outline-base-content overflow-hidden rounded-lg outline-2 outline-offset-2 outline"
                data-set-theme=    {themeNow}
                data-act-class="outline"

                onClick={ (e) => 
                  {props.changeChoseTheme(e, themeNow);
                }}
              >
                <div
                  data-theme=    {themeNow}
                ...
                >
                  <div className="grid grid-cols-5 grid-rows-3">
                    <div className="col-span-5 row-span-3 row-start-1 flex gap-1 py-3 px-4">
                      <div className="flex-grow text-sm font-bold">    {themeNow}</div>
